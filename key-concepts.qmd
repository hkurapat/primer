...
In the spirit of transparency, here are the guidelines which we provide to colleagues updating chapters in the *Primer* and the associated tutorials in the [**primer.tutorials**](https://ppbds.github.io/primer.tutorials/) package. This is how we think data science ought to be taught. It is also, perhaps unsurprisingly, how we think data science ought to be done, at least at this introductory level. Key concepts are bolded when they are first used.

## Question

Start with the question. These generally come in two types. First is a specific unknown number. Example:

> *What proportion of people who make $100,000 are liberal?*

Second is a more general query about the connection between variables. Example:

> *What is the relationship between income and political ideology?*

The first type of question is a subset of the second. We might estimate dozens of specific numbers when exploring the connection between income and ideology.
...
The more sophisticated the situation, the more likely we are to start with broader instructions.
...
**Quantity of Interest** is the number which you want to estimate. It is the answer to the question with which you begin. You will almost always calculate a posterior probability distribution for your Quantity of Interest since, in the real world, you will never know your QoI precisely. More sophisticated problems involve more than one QoI.
...
<!-- DK: Is the below true? It sounds cool . . .-->
