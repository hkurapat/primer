...
As we might expect, `sex` is most often "Male". To be more precise in inspecting our data, let's `skim()` the data set. 
...
Is the meaning of the columns consistent, i.e., can we assume validity? That is the heart of validity. To put it simply, does the column for lifespan in our Preceptor Table equate to the column for lifespan from our data set. Again, we look to the source of our data: @barfort2020. 
...
After looking at @barfort2020, the source for our data set, we see that:
