...
<!-- Update the tutorial, given the reorganization. -->
...
Must the world be stable? No! In fact, the world is always changing! The *stability* assumption, in this case, is a claim that the world has not changed that much between 2012 and 2024. Stability applies, not just to the data and the Preceptor Table rows, but to the entire Population Table. *Stability allows us to ignore the passage of time.*
