...
<!-- Get rid of list columns and map function since, one hopes, this is covered in R4DS?  -->
...
```{r}
#| echo: false
# Use nhanes dataset for this exercise, filter for adult and male.
...
## List-columns and map functions {#sec-rlist-columns-and-map-functions}
...
```{r}
#| echo: false
# DK: This code is a mess! Please fix! Store this data locally so that we can
# run it when not connected to the internet.

# Have to include otherwise shows up columns specification.



z <- read_csv("./probability/data/election-forecasts-2020/prez_1.csv",
              col_types = cols(cycle = col_double(),
                               branch = col_character(),
                               model = col_character(),
                               modeldate = col_character(),
...
draws <- tibble(ID = 1:1000000,
                electoral_votes = as.integer(sample(z$electoral_votes)))
...
<!-- Might be nice to start each Cardinal Virtue section -- both in this chapter and throughout the book --- with a relevant quote. -->
...
<!-- DK: Are these points too abstruse to include here?  -->
...
<!-- DK: Rewrite the below, I think. It is a mish-mash of old observations. Note that there is little discussion of hypothesis tests or model checks. -->
...
<!-- DK: Presidential example belongs in model checking, under Courage.   -->
...
{{< video https://www.youtube.com/embed/6C7yRBfh2ok >}}


<!-- ```{r, echo = FALSE, fig.cap = "The truth is out there"} -->
<!-- knitr::include_graphics("probability/images/truth_out_there.jpg") -->
<!-- ``` -->
