...
<!-- This chapter does not follow the standard Cardinal Virtue plan as closely as it might. Good or bad? -->
...
Our virtual urn needs a virtual shovel. We use `slice_sample()` and some list-column mapping wizardry learned in @sec-rlist-columns-and-map-functions to take a sample of 50 beads from our virtual urn.  
...
Using our rough calculations above, we conclude that our posterior for $\rho$ is $N(0.34, 0.134)$. So, our full data generating mechanism is:

$$ red_i  \sim Bernoulli(\rho) \text{with} \rho \sim N(0.34, 0.134)$$
