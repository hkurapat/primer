...
Switch to the Files pane on the bottom right:
...
The Files tab, within the Files pane, displays your computer's file system. When you create a project later, this tab will automatically show the contents of your project's folder. 
