...
<!-- Be careful! If you install tutorial.helpers from CRAN, and then, when you install r4ds.tutorials, don't update all packages, you won't get the PPBDS version of tutorial.helpers, which we need because of show_file(). -->
...
If you are using Windows, [download and install R Tools](https://cran.r-project.org/bin/windows/Rtools). Again, this is only for Windows users. The installer associated with "R-release" is what you want. 
...
```
  ...
  - Completed the "Getting Started with Tutorials" tutorial from the **tutorial.helpers** package.
